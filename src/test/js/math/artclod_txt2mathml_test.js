var a = function(fakeArray) { return Array.prototype.slice.call(fakeArray); };
var apply = function(){ return "<apply> " + a(arguments).join(" ") + " </apply>" ;  };
var ci = function(v){ return "<ci> " + v + " </ci>" ;  };
var cn = function(v){ return "<cn> " + v + " </cn>" ;  };
var times = "<times/>";
var divide = "<divide/>";
var plus = "<plus/>";
var minus = "<minus/>";
...
test("Adding two numbers", function() {
    equal(ARTC.txt2MathML.parse("2+4"), apply(plus, cn(2), cn(4)));
});

test("Adding three numbers", function() {
    equal(ARTC.txt2MathML.parse("2+4+7"), apply(plus, apply(plus, cn(2), cn(4)), cn(7)));
});
...
test("Subtracting two numbers", function() {
    equal(-2, ARTC.txt2MathML.parse("2-4"));
});
...
test("Subtracting three numbers", function() {
    equal(1, ARTC.txt2MathML.parse("12-4-7"));
});

test("Multplying two numbers", function() {
    equal(8, ARTC.txt2MathML.parse("2*4"));
});

test("Multplying three numbers", function() {
    equal(32, ARTC.txt2MathML.parse("2*4*4"));
});
...
test("Dividing two numbers", function() {
    equal(.5, ARTC.txt2MathML.parse("2/4"));
});

test("Dividing three numbers", function() {
    equal(1, ARTC.txt2MathML.parse("4/2/2"));
});
...
test("Can parse number then parens", function() {
    equal(63, ARTC.txt2MathML.parse("7(4 + 5)"));
});
...
test("Can parse back to back parens", function() {
    equal(81, ARTC.txt2MathML.parse("(3 + 6)(4 + 5)"));
});

test("2^2+(3*(5^(-1*-2))) = 79", function() {
    equal(79, ARTC.txt2MathML.parse("2^2+(3*(5^(-1*-2)))"));
});

test("2.5e1 + 6.2 = 31.2", function() {
    equal(31.2, ARTC.txt2MathML.parse("2.5e1 + 6.2"));
});
*/
